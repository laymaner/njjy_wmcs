...
import EChartssModule from "./views/echartstask.vue";
import EChartsroadwayModule from "./views/echartsroadway.vue";
import EChartstaskhisModule from "./views/echartstaskhis.vue";
import EChartsalarmModule from "./views/echartsalarm.vue";
import EChartsoutModule from "./views/echartsout.vue";
...
@Component({
    ...
    components: {
        EChartsModule,
        EChartssModule,
        EChartsroadwayModule,
        EChartstaskhisModule,
        EChartsalarmModule,
        EChartsoutModule,
        ChartCard,
        StatsCard
