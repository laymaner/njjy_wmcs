...
export default class Index extends Vue {
    ...
    get SEARCH_DATA() {
        return {
            ...
            formItem: {
                "interfaceCode":{
                    label: this.$t("interfaceconfig.interfaceCode"),
                    rules: [],
                    type: "input"
              },
                "interfaceName":{
                    label: this.$t("interfaceconfig.interfaceName"),
                    rules: [],
                    type: "input"
              },
                "interfaceUrl":{
                    label: this.$t("interfaceconfig.interfaceUrl"),
                    rules: [],
                    type: "input"
                    ,isHidden: !this.isActive
              },
            //     "retryMaxTimes":{
            //         label: this.$t("interfaceconfig.retryMaxTimes"),
            //         rules: [],
            //         type: "input"
            //         ,isHidden: !this.isActive
            //   },
            //     "retryInterval":{
            //         label: this.$t("interfaceconfig.retryInterval"),
            //         rules: [],
            //         type: "input"
            //         ,isHidden: !this.isActive
            //   },
