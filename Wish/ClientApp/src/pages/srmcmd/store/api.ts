...
const reqPath = config.headerApi + "/srmcmd/";
...
const dealcmdsend = {
  url: reqPath + "Dealcmdtasksend",
  method: "post"
};
const dealsrmpick = {
  url: reqPath + "Dealsrmtaskpick",
  method: "post"
};
const dealsrmput = {
  url: reqPath + "Dealsrmtaskput",
  method: "post"
};
const dealsrmrefuse = {
  url: reqPath + "Dealsrmtaskrefuse",
  method: "post"
};
const dealsrmtaskin = {
  url: reqPath + "Dealsrmtaskin",
  method: "post"
};
const dealsrmtaskout = {
  url: reqPath + "Dealsrmtaskout",
  method: "post"
};
const cmdresend = {
  url: reqPath + "Cmdresend",
  method: "post"
};
