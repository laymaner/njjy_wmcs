...
export default class Index extends Vue {
    ...
    get SEARCH_DATA() {
        return {
            ...
            formItem: {
                "interfaceCode":{
                    label: this.$t("interfacesendbackhis.interfaceCode"),
                    rules: [],
                    type: "input"
              },
                "interfaceName":{
                    label: this.$t("interfacesendbackhis.interfaceName"),
                    rules: [],
                    type: "input"
              },
                "interfaceSendInfo":{
                    label: this.$t("interfacesendbackhis.interfaceSendInfo"),
                    rules: [],
                    type: "input"
                    ,isHidden: !this.isActive
              },
                "interfaceResult":{
                    label: this.$t("interfacesendbackhis.interfaceResult"),
                    rules: [],
                    type: "input"
                    ,isHidden: !this.isActive
              },
                "returnFlag":{
                    label: this.$t("interfacesendbackhis.returnFlag"),
                    rules: [],
                    type: "select",
                ...
                "returnTimes":{
                    label: this.$t("interfacesendbackhis.returnTimes"),
                    rules: [],
                    type: "input"
                    ,isHidden: !this.isActive
              },
