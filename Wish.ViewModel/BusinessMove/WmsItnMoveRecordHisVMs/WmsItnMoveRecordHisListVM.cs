...
{
    public partial class WmsItnMoveRecordHisListVM : BasePagedListVM<WmsItnMoveRecordHis_View, WmsItnMoveRecordHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsItnMoveRecordHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsItnMoveRecordHis_View>>{
        ...
        public override IOrderedQueryable<WmsItnMoveRecordHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsItnMoveRecordHis>()
                ...
                .CheckContain(Searcher.toLocationType, x=>x.toLocationType)
                .CheckContain(Searcher.toPalletBarcode, x=>x.toPalletBarcode)
                ...
                .Select(x => new WmsItnMoveRecordHis_View
                {
				    ID = x.ID,
    ...
    public class WmsItnMoveRecordHis_View : WmsItnMoveRecordHis{
