...
{
    public partial class WmsItnMoveListVM : BasePagedListVM<WmsItnMove_View, WmsItnMoveSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsItnMove_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsItnMove_View>>{
        ...
        public override IOrderedQueryable<WmsItnMove_View> GetSearchQuery()
        {
            var query = DC.Set<WmsItnMove>()
    ...
    public class WmsItnMove_View : WmsItnMove{
