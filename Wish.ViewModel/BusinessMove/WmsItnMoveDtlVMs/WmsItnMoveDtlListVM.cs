...
{
    public partial class WmsItnMoveDtlListVM : BasePagedListVM<WmsItnMoveDtl_View, WmsItnMoveDtlSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsItnMoveDtl_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsItnMoveDtl_View>>{
        ...
        public override IOrderedQueryable<WmsItnMoveDtl_View> GetSearchQuery()
        {
            var query = DC.Set<WmsItnMoveDtl>()
                ...
                .Select(x => new WmsItnMoveDtl_View
                {
				    ID = x.ID,
                    whouseNo = x.whouseNo,
    ...
    public class WmsItnMoveDtl_View : WmsItnMoveDtl{
