...
{
    public partial class WmsPutawayDtlListVM : BasePagedListVM<WmsPutawayDtl_View, WmsPutawayDtlSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsPutawayDtl_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsPutawayDtl_View>>{
        ...
        public override IOrderedQueryable<WmsPutawayDtl_View> GetSearchQuery()
        {
            var query = DC.Set<WmsPutawayDtl>()
                ...
                .Select(x => new WmsPutawayDtl_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
                    binNo = x.binNo,
    ...
    public class WmsPutawayDtl_View : WmsPutawayDtl{
