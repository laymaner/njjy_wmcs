...
{
    public partial class WmsPutawayListVM : BasePagedListVM<WmsPutaway_View, WmsPutawaySearcher>
    {

        protected override IEnumerable<IGridColumn<WmsPutaway_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsPutaway_View>>{
        ...
        public override IOrderedQueryable<WmsPutaway_View> GetSearchQuery()
        {
            var query = DC.Set<WmsPutaway>()
    ...
    public class WmsPutaway_View : WmsPutaway{
