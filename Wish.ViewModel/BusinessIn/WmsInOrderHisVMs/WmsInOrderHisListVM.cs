...
{
    public partial class WmsInOrderHisListVM : BasePagedListVM<WmsInOrderHis_View, WmsInOrderHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsInOrderHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsInOrderHis_View>>{
        ...
        public override IOrderedQueryable<WmsInOrderHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsInOrderHis>()
                ...
                .Select(x => new WmsInOrderHis_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
                    cvCode = x.cvCode,
    ...
    public class WmsInOrderHis_View : WmsInOrderHis{
