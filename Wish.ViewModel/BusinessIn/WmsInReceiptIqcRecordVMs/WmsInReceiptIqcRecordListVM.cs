...
{
    public partial class WmsInReceiptIqcRecordListVM : BasePagedListVM<WmsInReceiptIqcRecord_View, WmsInReceiptIqcRecordSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsInReceiptIqcRecord_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsInReceiptIqcRecord_View>>{
        ...
        public override IOrderedQueryable<WmsInReceiptIqcRecord_View> GetSearchQuery()
        {
            var query = DC.Set<WmsInReceiptIqcRecord>()
                ...
                .CheckEqual(Searcher.erpQualifiedSpecialQty, x=>x.erpQualifiedSpecialQty)
                ...
                .CheckEqual(Searcher.erpUnqualifiedQty, x=>x.erpUnqualifiedQty)
                ...
                .Select(x => new WmsInReceiptIqcRecord_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
    ...
    public class WmsInReceiptIqcRecord_View : WmsInReceiptIqcRecord{
