...
{
    public partial class WmsInReceiptDtlHisListVM : BasePagedListVM<WmsInReceiptDtlHis_View, WmsInReceiptDtlHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsInReceiptDtlHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsInReceiptDtlHis_View>>{
        ...
        public override IOrderedQueryable<WmsInReceiptDtlHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsInReceiptDtlHis>()
                ...
                .Select(x => new WmsInReceiptDtlHis_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
                    batchNo = x.batchNo,
    ...
    public class WmsInReceiptDtlHis_View : WmsInReceiptDtlHis{
