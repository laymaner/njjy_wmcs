...
{
    public partial class WmsInReceiptIqcResultListVM : BasePagedListVM<WmsInReceiptIqcResult_View, WmsInReceiptIqcResultSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsInReceiptIqcResult_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsInReceiptIqcResult_View>>{
        ...
        public override IOrderedQueryable<WmsInReceiptIqcResult_View> GetSearchQuery()
        {
            var query = DC.Set<WmsInReceiptIqcResult>()
                ...
                .Select(x => new WmsInReceiptIqcResult_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
    ...
    public class WmsInReceiptIqcResult_View : WmsInReceiptIqcResult{
