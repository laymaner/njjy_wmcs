...
{
    public partial class WmsInOrderDtlListVM : BasePagedListVM<WmsInOrderDtl_View, WmsInOrderDtlSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsInOrderDtl_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsInOrderDtl_View>>{
        ...
        public override IOrderedQueryable<WmsInOrderDtl_View> GetSearchQuery()
        {
            var query = DC.Set<WmsInOrderDtl>()
                ...
                .CheckContain(Searcher.purchaseOrderNo, x=>x.purchaseOrderNo)
                ...
                .Select(x => new WmsInOrderDtl_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
                    batchNo = x.batchNo,
    ...
    public class WmsInOrderDtl_View : WmsInOrderDtl{
