...
{
    public partial class WmsInReceiptListVM : BasePagedListVM<WmsInReceipt_View, WmsInReceiptSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsInReceipt_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsInReceipt_View>>{
        ...
        public override IOrderedQueryable<WmsInReceipt_View> GetSearchQuery()
        {
            var query = DC.Set<WmsInReceipt>()
                ...
                .Select(x => new WmsInReceipt_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
                    binNo = x.binNo,
    ...
    public class WmsInReceipt_View : WmsInReceipt{
