...
{
    public partial class WmsInReceiptUniicodeListVM : BasePagedListVM<WmsInReceiptUniicode_View, WmsInReceiptUniicodeSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsInReceiptUniicode_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsInReceiptUniicode_View>>{
        ...
        public override IOrderedQueryable<WmsInReceiptUniicode_View> GetSearchQuery()
        {
            var query = DC.Set<WmsInReceiptUniicode>()
                ...
                .CheckContain(Searcher.externalInDtlId, x=>x.externalInDtlId)
                ...
                .Select(x => new WmsInReceiptUniicode_View
                {
				    ID = x.ID,
                    batchNo = x.batchNo,
    ...
    public class WmsInReceiptUniicode_View : WmsInReceiptUniicode{
