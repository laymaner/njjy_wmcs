...
{
    public partial class WmsOutInvoiceRecordListVM : BasePagedListVM<WmsOutInvoiceRecord_View, WmsOutInvoiceRecordSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsOutInvoiceRecord_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsOutInvoiceRecord_View>>{
        ...
        public override IOrderedQueryable<WmsOutInvoiceRecord_View> GetSearchQuery()
        {
            var query = DC.Set<WmsOutInvoiceRecord>()
                ...
                .CheckContain(Searcher.assemblyIdx, x=>x.assemblyIdx)
                ...
                .Select(x => new WmsOutInvoiceRecord_View
                {
				    ID = x.ID,
    ...
    public class WmsOutInvoiceRecord_View : WmsOutInvoiceRecord{
