...
{
    public partial class WmsOutInvoiceHisListVM : BasePagedListVM<WmsOutInvoiceHis_View, WmsOutInvoiceHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsOutInvoiceHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsOutInvoiceHis_View>>{
        ...
        public override IOrderedQueryable<WmsOutInvoiceHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsOutInvoiceHis>()
                ...
                .Select(x => new WmsOutInvoiceHis_View
                {
				    ID = x.ID,
                    cvCode = x.cvCode,
                    cvName = x.cvName,
    ...
    public class WmsOutInvoiceHis_View : WmsOutInvoiceHis{
