...
{
    public partial class WmsOutInvoiceUniicodeListVM : BasePagedListVM<WmsOutInvoiceUniicode_View, WmsOutInvoiceUniicodeSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsOutInvoiceUniicode_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsOutInvoiceUniicode_View>>{
        ...
        public override IOrderedQueryable<WmsOutInvoiceUniicode_View> GetSearchQuery()
        {
            var query = DC.Set<WmsOutInvoiceUniicode>()
                .CheckContain(Searcher.areaNo, x=>x.areaNo)
                .CheckContain(Searcher.batchNo, x=>x.batchNo)
                .CheckContain(Searcher.delayReason, x=>x.delayReason)
                ...
                .CheckEqual(Searcher.ouniiStatus, x=>x.ouniiStatus)
                .Select(x => new WmsOutInvoiceUniicode_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
                    batchNo = x.batchNo,
    ...
    public class WmsOutInvoiceUniicode_View : WmsOutInvoiceUniicode{
