...
{
    public partial class WmsOutInvoiceDtlListVM : BasePagedListVM<WmsOutInvoiceDtl_View, WmsOutInvoiceDtlSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsOutInvoiceDtl_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsOutInvoiceDtl_View>>{
        ...
        public override IOrderedQueryable<WmsOutInvoiceDtl_View> GetSearchQuery()
        {
            var query = DC.Set<WmsOutInvoiceDtl>()
                ...
                .Select(x => new WmsOutInvoiceDtl_View
                {
				    ID = x.ID,
    ...
    public class WmsOutInvoiceDtl_View : WmsOutInvoiceDtl{
