...
{
    public partial class WmsTaskHisListVM : BasePagedListVM<WmsTaskHis_View, WmsTaskHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsTaskHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsTaskHis_View>>{
        ...
        public override IOrderedQueryable<WmsTaskHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsTaskHis>()
    ...
    public class WmsTaskHis_View : WmsTaskHis{
