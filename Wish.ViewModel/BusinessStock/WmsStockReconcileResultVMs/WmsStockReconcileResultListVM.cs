...
{
    public partial class WmsStockReconcileResultListVM : BasePagedListVM<WmsStockReconcileResult_View, WmsStockReconcileResultSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsStockReconcileResult_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsStockReconcileResult_View>>{
        ...
        public override IOrderedQueryable<WmsStockReconcileResult_View> GetSearchQuery()
        {
            var query = DC.Set<WmsStockReconcileResult>()
                ...
                .Select(x => new WmsStockReconcileResult_View
                {
				    ID = x.ID,
    ...
    public class WmsStockReconcileResult_View : WmsStockReconcileResult{
