...
{
    public partial class WmsStockDtlHisListVM : BasePagedListVM<WmsStockDtlHis_View, WmsStockDtlHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsStockDtlHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsStockDtlHis_View>>{
        ...
        public override IOrderedQueryable<WmsStockDtlHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsStockDtlHis>()
    ...
    public class WmsStockDtlHis_View : WmsStockDtlHis{
