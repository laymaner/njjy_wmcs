...
{
    public partial class WmsItnInventoryRecordDifHisListVM : BasePagedListVM<WmsItnInventoryRecordDifHis_View, WmsItnInventoryRecordDifHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsItnInventoryRecordDifHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsItnInventoryRecordDifHis_View>>{
        ...
        public override IOrderedQueryable<WmsItnInventoryRecordDifHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsItnInventoryRecordDifHis>()
                ...
                .Select(x => new WmsItnInventoryRecordDifHis_View
                {
				    ID = x.ID,
                    batchNo = x.batchNo,
                    dataCode = x.dataCode,
    ...
    public class WmsItnInventoryRecordDifHis_View : WmsItnInventoryRecordDifHis{
