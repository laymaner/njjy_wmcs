...
{
    public partial class WmsItnInventoryRecordHisListVM : BasePagedListVM<WmsItnInventoryRecordHis_View, WmsItnInventoryRecordHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsItnInventoryRecordHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsItnInventoryRecordHis_View>>{
        ...
        public override IOrderedQueryable<WmsItnInventoryRecordHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsItnInventoryRecordHis>()
                ...
                .Select(x => new WmsItnInventoryRecordHis_View
                {
				    ID = x.ID,
    ...
    public class WmsItnInventoryRecordHis_View : WmsItnInventoryRecordHis{
