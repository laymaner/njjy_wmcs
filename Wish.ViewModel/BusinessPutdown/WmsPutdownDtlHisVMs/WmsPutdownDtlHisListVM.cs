...
{
    public partial class WmsPutdownDtlHisListVM : BasePagedListVM<WmsPutdownDtlHis_View, WmsPutdownDtlHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsPutdownDtlHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsPutdownDtlHis_View>>{
        ...
        public override IOrderedQueryable<WmsPutdownDtlHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsPutdownDtlHis>()
                ...
                .CheckEqual(Searcher.occupyQty, x=>x.occupyQty)
                ...
                .Select(x => new WmsPutdownDtlHis_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
    ...
    public class WmsPutdownDtlHis_View : WmsPutdownDtlHis{
