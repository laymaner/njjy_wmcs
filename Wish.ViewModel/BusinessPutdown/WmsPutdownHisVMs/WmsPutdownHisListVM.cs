...
{
    public partial class WmsPutdownHisListVM : BasePagedListVM<WmsPutdownHis_View, WmsPutdownHisSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsPutdownHis_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsPutdownHis_View>>{
        ...
        public override IOrderedQueryable<WmsPutdownHis_View> GetSearchQuery()
        {
            var query = DC.Set<WmsPutdownHis>()
                ...
                .Select(x => new WmsPutdownHis_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
                    binNo = x.binNo,
    ...
    public class WmsPutdownHis_View : WmsPutdownHis{
