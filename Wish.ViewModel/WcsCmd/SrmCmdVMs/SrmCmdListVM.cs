...
{
    public partial class SrmCmdListVM : BasePagedListVM<SrmCmd_View, SrmCmdSearcher>
    {

        protected override IEnumerable<IGridColumn<SrmCmd_View>> InitGridHeader()
        {
            return new List<GridColumn<SrmCmd_View>>{
        ...
        public override IOrderedQueryable<SrmCmd_View> GetSearchQuery()
        {
            var query = DC.Set<SrmCmd>()
                .CheckContain(Searcher.SubTask_No, x=>x.SubTask_No)
    ...
    public class SrmCmd_View : SrmCmd{
