...
{
    public partial class WmsItnQcRecordListVM : BasePagedListVM<WmsItnQcRecord_View, WmsItnQcRecordSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsItnQcRecord_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsItnQcRecord_View>>{
        ...
        public override IOrderedQueryable<WmsItnQcRecord_View> GetSearchQuery()
        {
            var query = DC.Set<WmsItnQcRecord>()
                ...
                .Select(x => new WmsItnQcRecord_View
                {
				    ID = x.ID,
                    areaNo = x.areaNo,
    ...
    public class WmsItnQcRecord_View : WmsItnQcRecord{
