...
{
    public partial class WmsItnQcListVM : BasePagedListVM<WmsItnQc_View, WmsItnQcSearcher>
    {

        protected override IEnumerable<IGridColumn<WmsItnQc_View>> InitGridHeader()
        {
            return new List<GridColumn<WmsItnQc_View>>{
        ...
        public override IOrderedQueryable<WmsItnQc_View> GetSearchQuery()
        {
            var query = DC.Set<WmsItnQc>()
    ...
    public class WmsItnQc_View : WmsItnQc{
