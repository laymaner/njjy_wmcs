...
{
    public class UdtWcsSocketSrm : BaseUdt
    {
        /// <summary>
        /// 任务号（流水号）
        /// </summary>
        public SocketSignal<Int16> TaskNo = new SocketSignal<Int16>("DB4", "0");
        /// <summary>
        ...
        /// </summary>
        public SocketSignal<Int16> ActionType = new SocketSignal<Int16>("DB4", "2");
        ...
        public UdtWcsSocketSrm(string db, int offset)
        {
            DB = db;
            Offset = offset;
        }
