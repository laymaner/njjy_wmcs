...
{
    [Table("INTERFACE_SEND_BACK")]
    public class InterfaceSendBack : BasePoco
    {
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        [StringLength(500, ErrorMessage = "接口名称长度不能超出500字符")]
        ...
        [StringLength(1000, ErrorMessage = "接口名称长度不能超出1000字符")]
