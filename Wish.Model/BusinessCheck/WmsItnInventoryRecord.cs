...
{
    [Table("WMS_ITN_INVENTORY_RECORD")]
	public class WmsItnInventoryRecord : BasePoco
	{
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        /// <summary>
        /// 盘点状态;0：初始创建；31:下架中；41：待盘点；49：盘点操作完成；90：盘点确认完成；92：已删除；93：强制结束盘点；
        /// </summary>
        [Column("INVENTORY_RECORD_STATUS")]
		[Required]
		//[StringLength(50, ErrorMessage = "盘点状态;0：初始创建；31:下架中；41：待盘点；49：盘点操作完成；90：盘点确认完成；92：已删除；93：强制结束盘点；长度不能超出50字符")]
