...
{
    [Table("WMS_IN_RECEIPT_RECORD_HIS")]
	public class WmsInReceiptRecordHis : BasePoco
	{
        /// <summary>
        /// 主键ID
        /// </summary>
		...
		/// <summary>
		/// 质量标记;0：待检；1：合格；2：不合格；
		/// </summary>
		[Column("INSPECTION_RESULT")]
		[Required]
        [Display(Name = "质量标记")]
        //[StringLength(50, ErrorMessage = "质量标记;0：待检；1：合格；2：不合格；长度不能超出50字符")]
        ...
        [Display(Name = "实际上架后的库存编码")]
        //[StringLength(100, ErrorMessage = "实际上架后的库存编码长度不能超出100字符")]
		public Int64 ptaStockDtlId { get; set; }
        ...
        [StringLength(100, ErrorMessage = "实际上架库位号长度不能超出100字符")]
		...
		[Required]
        [Display(Name = "库区编号")]
        [StringLength(100, ErrorMessage = "库区编号：待上架长度不能超出100字符")]
		...
		[StringLength(2000, ErrorMessage = "回传结果长度不能超出2000字符")]
		...
		[Column("SKU_CODE")]
        //[Display(Name = "SKU 编码")]
        [StringLength(255, ErrorMessage = "SKU 编码长度不能超出255字符")]
		...
		[Required]
        //[Display(Name = "数据来源")]
        [StringLength(50, ErrorMessage = "数据来源长度不能超出50字符")]
